    ...
    return (
      <div className="cell example example3">
        ...
        <div className="fieldset" >
          ...
          {
            this.state.paymentSuccess === null ? (<h1></h1>) : (
                !this.state.paymentSuccess ? (
            <div className="error" role="alert">
              <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" width="17" height="17" viewBox="0 0 17 17">
              ...
              <span className="message">Your credentials are invalid, please try again.</span>
            </div>
                ) : (
